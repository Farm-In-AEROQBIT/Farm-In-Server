...
@RestController
@RequestMapping("/api/reserve_temperature")
public class Reserve_TemperatureApiController {
    ...
    public ResponseEntity<Reserve_TemperatureResponse> getTemperatureSensorData(@PathVariable String reserveSowsRoomNum) {
