...
@RestController
@RequestMapping("v1/api/boars_co2")
public class Boars_Co2ApiController {
    ...
    public ResponseEntity<Boars_Co2Response> getCo2SensorData(@PathVariable Long boarsBarnRoomNum) {
    ...
    public ResponseEntity<Resource> exportCo2Data() {
        ...
        try {
            ...
            headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=boars_co2_data.xlsx");
