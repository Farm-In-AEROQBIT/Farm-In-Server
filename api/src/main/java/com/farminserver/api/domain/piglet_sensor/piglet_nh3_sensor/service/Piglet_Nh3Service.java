...
import com.farminserver.db.boars_nh3_sensor.Maternity_Nh3SensorRepository;
...
public class Piglet_Nh3Service {
    ...
    @Autowired
    public Boars_Nh3Service(Maternity_Nh3SensorRepository repository, Boars_Nh3Converter converter, Boars_ExcelExporter excelExporter) {
    ...
    public Boars_Nh3Response getNh3Data(String boarsBarnRoomNum) {
        Maternity_Nh3SensorEntity entity = repository.findById(boarsBarnRoomNum).orElseThrow(() -> new RuntimeException("Sensor data not found"));
