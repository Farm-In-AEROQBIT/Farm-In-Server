package com.farminserver.api.domain.pm_sensor.controller.model;
...
public class PmResponse {
    ...
    public PmResponse(double pm1_0, double pm2_5, double pm10, double totalPm, String unit, long timestamp) {
        this.pm1_0 = pm1_0;
        this.pm2_5 = pm2_5;
        this.pm10 = pm10;
